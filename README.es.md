...
2. Descomprimilo.
3. Abrí la carpeta extraída `The-Player-1.3.0-windows`.
...
Descomprimí ese archivo y ejecutá `The-Player-1.3.0-windows\start.cmd`. El ZIP portátil generado incluye `runtime\node.exe`, así que los usuarios finales del ZIP no necesitan Node.js ni npm.
